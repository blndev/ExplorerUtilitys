========================================================================
    STATISCHE BIBLIOTHEK: Lib.Win32UI-Projektübersicht
========================================================================

Dieses Lib.Win32UI-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Lib.Win32UI-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Lib.Win32UI.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
